...
class MainUI():
    def setupGUI(self, MainWindow):
        ...
        self.basicButtonsLayout = QtWidgets.QVBoxLayout()
        self.basicButtonsLayout.addWidget(self.originalButton)
        self.basicButtonsLayout.addWidget(self.grayButton)
        self.basicButtonsLayout.addWidget(self.histButton)
        self.basicButtonsLayout.addWidget(self.equalizedHistButton)
        ...
        self.periodicLayout.addWidget(self.periodicButton)
        self.periodicLayout.addWidget(self.periodic2Button)
        ...
        self.mainLayout.addLayout(self.basicButtonsLayout,3,0, 1, QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignTop)
        self.mainLayout.addLayout(self.periodicLayout,4,0, 1, QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignTop)
        self.mainLayout.addLayout(self.bottomLayout,5,0, 1, QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignTop)
